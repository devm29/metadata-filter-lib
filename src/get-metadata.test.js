...
const htmlExTrimming = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta property="og:url" content="   https://example.org/path   " />
...
describe("get-metadata.js - getMetadata()", () => {
  ...
  test("Trims text values and cleans keyword entries", () => {
    expect(getMetadata(htmlExTrimming)).toEqual({
